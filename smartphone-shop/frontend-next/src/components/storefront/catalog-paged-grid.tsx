    ...
    const className = edge
      ? `ui-btn inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-soft)] text-[var(--color-text-muted)] text-sm transition-[transform,background-color,color,border-color,box-shadow,opacity] duration-200 ${
          isDisabled
            ...
            : "hover:!translate-y-0 hover:translate-x-1.5 hover:border-white/12 hover:bg-white hover:text-black hover:shadow-[0_10px_22px_rgba(0,0,0,0.38)]"
        }`
      : `ui-btn inline-flex h-11 min-w-11 items-center justify-center rounded-xl border px-3 py-1.5 text-sm transition-[transform,background-color,color,border-color,box-shadow,opacity] duration-200 ${
          isActivePage
            ? "pointer-events-none cursor-default border-black/80 bg-[var(--color-primary)] font-semibold text-black hover:!translate-x-0 hover:!translate-y-0"
            : "border-[var(--color-border)] bg-[var(--color-surface-soft)] text-[var(--color-text-muted)] hover:!translate-y-0 hover:translate-x-1.5 hover:border-white/12 hover:bg-white hover:text-black hover:shadow-[0_10px_22px_rgba(0,0,0,0.38)]"
