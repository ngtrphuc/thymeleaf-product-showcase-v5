...
export function StorefrontCompareBanner() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-5 left-1/2 z-[60] w-[min(92vw,760px)] -translate-x-1/2">
      <Link
        href="/compare"
        className="pointer-events-auto flex items-center justify-between gap-3 rounded-2xl border border-zinc-600/60 bg-[#111111]/95 px-4 py-3 text-sm shadow-[0_16px_30px_rgba(0,0,0,0.5)] backdrop-blur-sm transition hover:-translate-y-0.5 hover:border-zinc-400/80"
      >
